...
\def\Acknowledgements{
    I like to thank Ji\v{r}\'{i} Bene\v{s} and Dr. Jonathan Immanuel Brachthäuser for their support and advice during the implementation phase, as well as their feedback on writing the thesis. I also want to thank my parents for giving me the time and space to work on this thesis, as well as their support and feedback on it.
}
